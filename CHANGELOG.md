...
* Tmp file deleted
* Release note deleted
* Dependencies management update
* 1234 Use bundled sync-gateway
* Add vendor/sync_gateway submodule
* VFS-1552 Creating couchdb changes tests
* VFS-1234 add doc for force_save function
* VFS-1234 fix couchdb teardown
* VFS-1234 fix couchdb teardown
* VFS-1234 improve couchdb teardown
* VFS-1234 update docs
* VFS-1234 hack dialyzer
* VFS-1476, Minor tests update
* VFS-1476, Upgrade of stress tests
* VFS-1476, Upgrade datastore tests
* VFS-1476, Tests update
* VFS-1476, Tasks flood repair
* VFS-1234 fix get_db() usage
* VFS-1234 make couchdb_datastore_driver default
* VFS-1476, Minor test update
* VFS-1476, Stress test update
* VFS-1476, Deps update
* VFS-1476, Update of performance tests
* VFS-1405 lower the number of sync-gateways
* Fix dialyzer.
* Squashed 'bamboos/' changes from ea16980..0665aad
* VFS-1405 update test env to use new DB driver
* Switch to Erlang 18.0
* updated email in readme
* VFS-1500, upgrade vm.args description
* VFS-1500, repair cover
* VFS-1500, decrease memory usage
* VFS-1234 add some docs
* VFS-1476, Tests update
* VFS-1421 Update ctool.
* VFS-1477, Minor stress test update
* VFS-1477, Deps update
* VFS-1477, Deps update
* VFS-1477, Deps update
* VFS-1477, Upgrade of stress/performance tests
* VFS-1234 Fix worker_host's timer router
* VFS-1234 Fix datastore init
* VFS-1234 Add init_driver callback to datastore drivers
...
* VFS-1148 fix a typo
* VFS-1148 fix a spec
* VFS-1148 refactor nagios listener for less code repeating
* Squashed 'bamboos/' changes from b605f93..ea16980
* VFS-1493, Deps update
* VFS-1493, Fix node manager start race with workers supervisor
* VFS-1148 fix a bad spec
* VFS-1148 remove all code connected to http_worker
* VFS-1148 remove http_worker, move endpoints check to nagios
* VFS-1455 Update ctool.
* VFS-1457 updating ctool ref
* Squashed 'cluster_manager/' changes from 2eb62fe..41ddcec
* Squashed 'bamboos/' changes from ff23669..b605f93
* VFS-1457 updating ctool ref
* Squashed 'bamboos/' changes from 9393a5b..ff23669
* VFS-1457 renaming main module
* VFS-1457 fixing duplicate module
* VFS-1457 renaming cluster manager in worker
* VFS-1457 fix ccm app name
* VFS-1457 moving subtree
...
* VFS-1382 manual merge fixes
* VFS-1382 cleaning dependencies
* VFS-1382 fixing nagios
* VFS-1382 removing helpers
* Squashed 'op_ccm/' changes from bd74202..4c75039
* VFS-1382 renaming cookie
* VFS-1382 changing cookie
* Squashed 'op_ccm/' changes from fa69024..bd74202
* VFS-1382 review issues addressed (nagios name + refactoring)
* Merge commit '2a2ff863269fce13fe051955be7d2b2b67a8163c' into feature/VFS-1382-cluster-framework
* Squashed 'bamboos/' changes from 63b9ff6..7f1b0f3
...
* Merge commit '9d56df3b3b0f9a35a882d5b3e4686d45f997b63f' into feature/VFS-1382-cluster-framework
* Squashed 'bamboos/' changes from 4a4a179..63b9ff6
...
* VFS-1382 removed unnecessary logs
...
* VFS-1382 datastore cache level infered from models
...
* VFS-1382 restored original order of code blocks
* VFS-1382 removed inlude_lib to own headers
* VFS-1382 small refactoring
...
* VFS-1382 removed dead code
* VFS-1382 restored lib dirs
* VFS-1363 Default open mode to rdwr in translator
* VFS-1382 fixed todos
* VFS-1340 bugfix
* VFS-1340 create_file_test passing
* VFS-1382 ref=verted protocols plugins (adds todo)
* VFS-1382 post merge trimming & fixes
* Merge remote-tracking branch 'remotes/origin/feature/VFS-1382-cluster-framework' into cluster-worker-example
* VFS-1403 Remove usage of mimetype taken from attrs.
* VFS-1403 Update ctool.
* VFS-1382 fixed deps applications after merge
...
* Merge branch 'develop' into feature/VFS-1382-cluster-framework
...
* VFS-1382 hacking build by links
* VFS-1382 hacking build by links
...
* VFS-1382 moved listener starter
...
* VFS-1340-bug fixes
* VFS-1382 removing ct from config
...
* Squashed 'op_ccm/' changes from 527bc6f..9e4a019
* Squashed 'bamboos/' changes from 9200fc7..5a48c50
* Squashed 'appmock/' changes from c3bc2cc..9bad307
* VFS-1382 removing unnecessary ct test
* VFS-1404 Update ctool.
...
* Squashed 'bamboos/' changes from 60305c2..9200fc7
...
* Merge remote-tracking branch 'remotes/origin/feature/VFS-1338-2-create-a-container-object-http' into feature/VFS-1341-read-a-data-object-using-http
* Merge remote-tracking branch 'remotes/origin/develop' into feature/VFS-1382-cluster-framework
...
* Merge commit 'e345620acd9a3abb90bfe9a9d5857e4fba4c2985' into feature/VFS-1241-env_configurator-in-onedata-repo
...
* Merge commit '87ad023fc88a7d5c64dc5668c5d943a1ca19f49b' into feature/VFS-1241-env_configurator-in-onedata-repo
* Squashed 'bamboos/' changes from 57807a0..7797628
* VFS-1241 add default values to logdir arg in up scripts
* VFS-1241 add default values to logdir arg in up scripts
* Merge commit '22f6e2e4b6c9a8372d9fb50876f08ba04f20ab1a' into feature/VFS-1241-env_configurator-in-onedata-repo
* Squashed 'bamboos/' changes from 63771a0..57807a0
...
* Merge commit '93e76cc8770c8cec65e149c2bbb08e4b34da2702' into feature/VFS-1241-env_configurator-in-onedata-repo
* Squashed 'bamboos/' changes from b17e4d1..63771a0
...
* Merge commit 'c38b5237862753f5a69730e6c90399375be8e399' into feature/VFS-1191-dns-and-token-flow
* Squashed 'bamboos/' changes from d8cbc41..b17e4d1
...
* Merge commit '2ab5e6b0273b32dc6bbe9aaa06b2b2f93f954d38' into feature/VFS-1191-dns-and-token-flow
* Squashed 'bamboos/' changes from b800f26..d8cbc41
...
* Merge commit '6042d3af92395e7b8d4f1fd9c8741cc33c2d0900' into feature/VFS-1191-dns-and-token-flow
* Squashed 'bamboos/' changes from 89211d2..b800f26
...
* Merge commit 'afe59d864fd3debd075d582c3e4feed8834b0081' into feature/VFS-1191-dns-and-token-flow
* Squashed 'bamboos/' changes from a52ffd1..89211d2
* VFS-1191 update env
...
* Squashed 'op_ccm/' changes from beac3a1..1496df2
* Merge commit 'cc35c1245901539f003ffeeace1339c7d0ed2da8' into feature/VFS-1191-dns-and-token-flow
* Squashed 'bamboos/' changes from 950ffd4..a52ffd1
...
* Merge commit 'a330d9e8c14c2f2792da596af6fce0b398f137a1' into feature/VFS-1172-move-provider-registration-logic
* Squashed 'bamboos/' changes from 72b50f4..950ffd4
...
* Merge commit 'ad085dac366e145960e0ca1ff5d9d411a20396da' into feature/VFS-1172-move-provider-registration-logic
...
* Merge commit '62a5d82d342c759e8ec8ea89d308064a53bcbe54' into feature/VFS-1172-move-provider-registration-logic
* Squashed 'bamboos/' changes from b9e5c93..85d7862
* VFS-1172, add new example env desc
* Merge commit '36e4ea3b6dad8ff15109edb242024834f12e57d7' into feature/VFS-1172-move-provider-registration-logic
...
* Merge commit '22223d207b7f70910abb7099d0e1064902c90702' into feature/VFS-1172-move-provider-registration-logic
...
* Squashed 'op-ccm/' changes from ea695dc..c2d9104
* Merge commit '30d8c21959fd047db17dbed5a97fbaa66a4ea44a' into feature/VFS-1172-move-provider-registration-logic
* Squashed 'bamboos/' changes from e8250b3..caac3db
...
* Merge commit 'd3386a159c95a9841aeef9c2c4dafdcf1d703961' into feature/VFS-1172-move-provider-registration-logic
...
* Merge commit '69ad2569b28eb496814fb667b6b9f90fed714b9e' into feature/VFS-1138-node-package-distribution-selection
...
* Merge commit '9d4d91aa53c4dc71bb36df3ac02667774e798140' into feature/VFS-1129-packages-deb-and-rpm
...
* Merge commit '22bce5abb69872f2bd950aa467a1e67a2d2e5e47' as 'bamboos'
...
* VFS-40, dodalem do skryptow podawanie wezlow DBMS w argumentach,zupdatowalem README
* version 0.0.4
* VFS-61: Eliminacja ensure_db_exists
* VFS-61: Poprawka save_record_test
* VFS-61: Pola powinny byc sortowane tylko w krotkach. Nigdy w rekordzie.
* VFS-61: Doc update
* VFS-61: Lepszy random:seed - gwarancja unikalnosci w klastrze
* VFS-61: Lepszy random:seed - zmniejszona szansa na kolizje w obrebie klastra, oraz przyspieszenie dzialania w obrebie procesu
* VFS-61: Testy do dao_cluster + usuniety race condition przy wstepnym dodawaniu hostow DB
* VFS-61: typo fix
* VFS-61: Zmiana wersji
* VFS-61: Lista nodow DBMS dodana do configa releasu + drobne poprawki
* VFS-61: Mozliwosc nadpisania rekordu + poprawki testow
* VFS-61: Unit testy dla nowych wersji metod dao
* VFS-61: Aktualizacja oblugiwanych rekordow
* VFS-61: Refaktoryzacja kodu save_record, remove_record, get_record, wstepny cleanup kodu
* VFS-61: doc_to_term - wersja robocza
* VFS-61: term_to_doc - wersja robocza
* VFS-40, ostateczna wersja
* VFS-40, ostateczna wersja
* VFS-40, chyba ostateczna wersja
* VFS-40, chyba ostateczna wersja
* VFS-40, więcej poprawek readme
* VFS-40, więcej poprawek readme
* VFS-40, więcej poprawek readme
* VFS-40, więcej poprawek readme
* VFS-40, więcej poprawek readme
* VFS-40, więcej poprawek readme
* VFS-40, readme popraaaaawki (musze puszowac zeby zobaczyc efekty formatowania)
* VFS-40, Kolejna poprawka README
* VFS-41, Update of format of lager config
* VFS-41, Lagger config update
* VFS-40, Kolejna poprawka README
* VFS-40, Poprawka README
* Dorzucam vars.config do repo, żeby się kompilowało gdy pominiemy skrypt.
* Drobne poprawki pod kątem zmergowania kodu.
* Poprawiony readme
...
* Opisanie funkcjonalnosci w readme, drobne poprawki.
* Zapamietywanie zawartosci reltool.config i przywracanie jej po wykonaniu skryptu. Wyrzucenie vars.config z repo
* Dodanie skryptu gen_test i opcjonalnego pliku z argumentami gen_test.args. Generuje on zestaw paczek releasowych do lokalnego testowania.
* Dodanie pliku gen_dev.args z argumentami, nowe opcje w makefile (w start_config jeszcze brakuje odpalenia paczki na koniec)
* VFS-41, Lager test
* VFS-41, Lager config update
* VFS-41, Config update for lager
* Naprawienie buga z przecinkiem
* VFS-41, Lager start test
* Lager config added.
* Wprowadzone poprawki do skryptu.
* Wrzucilem skypt (w pliku o tajemniczej nazwie 'skrypt')
* VFS-44,VFS-30: Nazewnictwo w worker_plugin_behaviour
* VFS-14, Fun names update
* VFS-14, test update
* VFS-14, Doc update.
* VFS-14, Update of rebar config
* VFS-14, Doc update.
* VFS-14, Tests update
* VFS-44: dao:handle/2 doc update
* VFS-44: Zmiana API dao_cluster
* VFS-14, Nodes monitoring added.
* VFS-44: Wymuszenie wlaczania daemona epmd podczas unit testow
* VFS-44: Poprawka inicjacji testu
* Revert "VFS-44: Usuniecie pliku edytora"
* VFS-44: Usuniecie pliku edytora
* VFS-44: Maly update dao:handle/2
* VFS-44: Podzial API na pod-moduly
* VFS-44: Zmiana wywolan sieciowych na "zaslepki" (meck). Hack z poprzedniego commita byl... coz, brzydkim hackiem.
* VFS-44: Zmiana wywolan sieciowych na "zaslepki" (meck). Hack z poprzedniego commita byl... coz, brzydkim hackiem.
* VFS-44: Obejście czasami niestartującego daemona 'epmd'
* VFS-14, Heart beat from node manager added.
* New version
* VFS-14, Worker_host tests added.
* New in git ingore
* New value in git ignore
* Merge branches 'VFS-44' and 'master' of ssh://git.plgrid.pl:7999/VFS/veilcluster
* VFS-14, Doc updated
* VFS-14, CCM updated
* VFS-44: Krotki szkielet DAO
* VFS-44: Skip deps + drobna poprawka zaleznosci w Makefile
* VFS-44: Komentarze do makr
* VFS-44: Usuniecie nieuzywanego kodu
* VFS-14, Doc update
* VFS-14, Reorganization of code
* VFS-44: Wykonczenie szkieletu dao
* VFS-44: Tworzenie widokow
* VFS-44: Pobieranie i kasowanie rekordow z bazy
* VFS-44: Reformat kodu
* VFS-44: Pobieranie rekordu uzywa modulu dao_json
* VFS-44: Reformat kodu
* VFS-44: Prosta strukturalna obsluga obiektow JSON'a w formacie BigCouch'a
* VFS-44: Zapis rekordow - usuniecie duplikatow
* VFS-44: Zapis rekordow
* VFS-44: Szybsze odrzucanie niekatywnych hostow, obsluga dokumentow (dao_helper), ujednolicenie zwracanych wartosci (dao_helper)
...
* VFS-48,50, Config update
* VFS-48,50, Config update
* VFS-48,50, Config update
* VFS-48,50, Documentation updated.
* VFS-48,50, Modules and cluster manager update
* VFS-48,50, Cluster and modules managers initial versions
* VFS-44: Emacs reformat - poprawka
* VFS-44: Emacs reformat
* VFS-44: dao_helper - czesc metod niskiego poziomu, drobne poprawki
* VFS-44: Zmiana metody znajdowania uszkodzonych node'ow dbms
* VFS-44: DB Host Selector
* VFS-44: Integracja modulow
* VFS-44: Wstepna struktura plikow
* VFS-48,50, ccm config update
* VFS-48,50, Config update
* VFS-48,50, Vars update
* VFS-48,50, config update
* VFS-48,50, Node update
...
* Zmienilem plik "dummy.txt"
* Zmienilem plik "dummy.txt"
* Drobna poprawka w makefile'u. Opcja Generate wymaga compile
* Drobna poprawka w makefile'u. Opcja Generate wymaga compile
* VFS-30, Readme update
* VFS-30, Hot code swapping added
* VFS-30, Documentation (for edoc) updated.
* VFS-30, Automatic generation of documentation added.
* VFS-30, Makefile update
* VFS-30, Makefile added, files documentation updated.
* VFS-30, License and files description added.
* VFS-30, Comment updated
* VFS-30, Node type configuration added
* VFS-30, Templates test.
* VFS-30, version number corrected.
* VFS-30, info about Erlang version added.
* VFS-30, chmod +x done on new rebar file
* VFS-30, Rebar test
* VFS-30 rebar test
* .gitignore update
* VFS-30, README.txt -> dummy.txt
* VFS-30, modules names updated
* VFS-30, chmod +x done on executable files
* VFS-30 - Eclipse project upgrade
* exec attr
* Update of Eclipse project.
* Checking README.md view in Stash.
* Commit test from Eclipse.
* VFS-30 names update
* VFS-30 - empty dirs for modules added
* VFS-30
* Initial Commit
* Initial Commit
### 2.0.0
