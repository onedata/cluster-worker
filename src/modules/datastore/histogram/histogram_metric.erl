...
-spec update(metric(), histogram_windows:timestamp(),
...
-spec get(metric(), histogram_windows:get_options(),
...
-spec update(data(), key(), non_neg_integer(), splitting_strategy(),
