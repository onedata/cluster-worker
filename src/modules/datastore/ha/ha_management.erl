...
%% API
-export([get_propagation_method/0, get_backup_nodes/0, get_slave_mode/0, change_config/2]).
-export([master_down/0, master_up/0]).
...
% TODO - iteracja po wszzystkich procesach zeby zrobic config lub przejecie
