...
-export([create_delete_db_test/1, save_db_test/1, update_db_test/1, get_db_test/1, exists_db_test/1, links_db_test/1,
    create_delete_global_store_test/1, save_global_store_test/1, update_global_store_test/1,
    ...
    list_db_test/1, list_global_store_test/1, list_local_store_test/1,
    list_global_cache_test/1, list_local_cache_test/1
]).
%%test_bases
-export([create_delete_db_test_base/1, save_db_test_base/1, update_db_test_base/1,
    ...
    create_delete_global_store_test_base/1, save_global_store_test_base/1,
    update_global_store_test_base/1, get_global_store_test_base/1,
    ...
    list_db_test_base/1, list_global_store_test_base/1, list_local_store_test_base/1,
    list_global_cache_test_base/1, list_local_cache_test_base/1
]).

-define(TEST_CASES, [
    create_delete_db_test, save_db_test, update_db_test, get_db_test, exists_db_test, links_db_test,
    create_delete_global_store_test, save_global_store_test, update_global_store_test,
...
%	links_local_store_test, links_local_cache_test,
    ...
    list_db_test, list_global_store_test, list_local_store_test,
    list_global_cache_test, list_local_cache_test
]).
...
list_db_test(Config) ->
    ?PERFORMANCE(Config, ?long_test_def).
list_db_test_base(Config) ->
    datastore_basic_ops_utils:list_test_base(Config, disk_only).

list_global_store_test(Config) ->
    ?PERFORMANCE(Config, ?long_test_def).
list_global_store_test_base(Config) ->
    datastore_basic_ops_utils:list_test_base(Config, global_only).

list_local_store_test(Config) ->
    ?PERFORMANCE(Config, ?long_test_def).
list_local_store_test_base(Config) ->
    datastore_basic_ops_utils:list_test_base(Config, local_only).

list_global_cache_test(Config) ->
    ?PERFORMANCE(Config, ?long_test_def).
list_global_cache_test_base(Config) ->
    datastore_basic_ops_utils:list_test_base(Config, globally_cached).

list_local_cache_test(Config) ->
    ?PERFORMANCE(Config, ?long_test_def).
list_local_cache_test_base(Config) ->
    datastore_basic_ops_utils:list_test_base(Config, locally_cached).
