...
normalize_seq_test() ->
    ...
    ?assertEqual(423564564564, couchdb_datastore_driver:normalize_seq(<<"931809318::423564564564">>)),
    ?assertEqual(931809318, couchdb_datastore_driver:normalize_seq(<<"423564564564::931809318">>)),
